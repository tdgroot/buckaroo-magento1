<?php
class TIG_Buckaroo3Extended_Block_PaymentFee_Order_Totalbar extends Mage_Core_Block_Abstract
{
    public function initTotals()
    {
        ...
        $feeLabel = Mage::helper('buckaroo3extended')->getfeeLabel($this->_invoice->getOrder());
