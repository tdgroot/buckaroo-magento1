<?php 
class TIG_Buckaroo3Extended_Model_PaymentMethods_Empayment_PaymentMethod extends Mage_Payment_Model_Method_Abstract
{
    ...
    public function isAvailable($quote = null)
    {
    	...
    	if (Mage::getStoreConfig('buckaroo/buckaroo3extended_empayment/allowspecific', Mage::app()->getStore()->getStoreId()) == 1
    		&& $quote->getBillingAddress()->getCountry()) 
    	{
    		$allowedCountries = explode(',',Mage::getStoreConfig('buckaroo/buckaroo3extended_empayment/specificcountry', Mage::app()->getStore()->getStoreId()));
    	...
    	if (!Mage::getStoreConfig('buckaroo/buckaroo3extended_empayment/active', Mage::app()->getStore()->getStoreId())) {
    		return false;
    	}
    	
    	//limit by ip
    	if (mage::getStoreConfig('dev/restrict/allow_ips') && Mage::getStoreConfig('buckaroo/buckaroo3extended_empayment/limit_by_ip'))
    	{
