<?php 
class TIG_Buckaroo3Extended_Model_PaymentMethods_Onlinegiro_PaymentMethod extends Mage_Payment_Model_Method_Abstract
{
    ...
    public function isAvailable($quote = null)
    {
    	...
    	if (Mage::getStoreConfig('buckaroo/buckaroo3extended_onlinegiro/allowspecific', Mage::app()->getStore()->getStoreId()) == 1
    		&& $quote->getBillingAddress()->getCountry()) 
    	{
    		$allowedCountries = explode(',',Mage::getStoreConfig('buckaroo/buckaroo3extended_onlinegiro/specificcountry', Mage::app()->getStore()->getStoreId()));
    	...
    	if (!Mage::getStoreConfig('buckaroo/buckaroo3extended_onlinegiro/active', Mage::app()->getStore()->getStoreId())) {
    		return false;
    	}
    	
    	//limit by ip
    	if (mage::getStoreConfig('dev/restrict/allow_ips') && Mage::getStoreConfig('buckaroo/buckaroo3extended_onlinegiro/limit_by_ip'))
    	{
