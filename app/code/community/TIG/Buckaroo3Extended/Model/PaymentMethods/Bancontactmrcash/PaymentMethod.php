<?php
class TIG_Buckaroo3Extended_Model_PaymentMethods_Bancontactmrcash_PaymentMethod extends Mage_Payment_Model_Method_Abstract
{
    protected $_payment;
    ...
    public function isAvailable($quote = null)
    {
    	...
    	if (Mage::getStoreConfig('buckaroo/buckaroo3extended_bancontactmrcash/allowspecific', Mage::app()->getStore()->getStoreId()) == 1
    		&& $quote->getBillingAddress()->getCountry())
    	{
    		$allowedCountries = explode(',',Mage::getStoreConfig('buckaroo/buckaroo3extended_bancontactmrcash/specificcountry', Mage::app()->getStore()->getStoreId()));
    	...
    	if (!Mage::getStoreConfig('buckaroo/buckaroo3extended_bancontactmrcash/active', Mage::app()->getStore()->getStoreId())) {
    		return false;
    	}

    	//limit by ip
    	if (mage::getStoreConfig('dev/restrict/allow_ips') && Mage::getStoreConfig('buckaroo/buckaroo3extended_bancontactmrcash/limit_by_ip'))
    	{
