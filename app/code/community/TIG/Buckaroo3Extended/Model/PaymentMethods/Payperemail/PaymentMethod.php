<?php 
class TIG_Buckaroo3Extended_Model_PaymentMethods_Payperemail_PaymentMethod extends Mage_Payment_Model_Method_Abstract
{
    protected $_payment;
    ...
    public function isAvailable($quote = null)
    {
    	...
    	if (Mage::getStoreConfig('buckaroo/buckaroo3extended_payperemail/allowspecific', Mage::app()->getStore()->getStoreId()) == 1
    		&& $quote->getBillingAddress()->getCountry()) 
    	{
    		$allowedCountries = explode(',',Mage::getStoreConfig('buckaroo/buckaroo3extended_payperemail/specificcountry', Mage::app()->getStore()->getStoreId()));
    	...
    	if (!Mage::getStoreConfig('buckaroo/buckaroo3extended_payperemail/active', Mage::app()->getStore()->getStoreId())) {
    		return false;
    	}
    	
    	//limit by ip
    	if (mage::getStoreConfig('dev/restrict/allow_ips') && Mage::getStoreConfig('buckaroo/buckaroo3extended_payperemail/limit_by_ip'))
    	{
