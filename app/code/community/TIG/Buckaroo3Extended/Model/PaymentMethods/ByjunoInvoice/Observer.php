<?php
class TIG_Buckaroo3Extended_Model_PaymentMethods_ByjunoInvoice_Observer extends TIG_Buckaroo3Extended_Model_Observer_Abstract 
{    
    ...
    public function buckaroo3extended_request_addcustomvars(Varien_Event_Observer $observer)
    {
        ...
        $array = array(
            'MerchantSendsEmail'    => Mage::getStoreConfig('buckaroo/buckaroo3extended_byjunoinvoice/send_mail', Mage::app()->getStore()->getStoreId()) ? 'false' : 'true',
